...
export const GridScan = ({
  ...
  useEffect(() => {
    // Ajuste del proyecto: si el webcam/face-tracking está desactivado (caso
    // de uso por defecto en esta demo — un fondo decorativo no debe pedir
    // permiso de cámara ni bajar ~1-2MB de pesos de modelo TinyFaceDetector
    // que nunca se van a usar), no cargamos face-api.js en absoluto. El
    // shader del grid-scan funciona igual sin el tracking facial.

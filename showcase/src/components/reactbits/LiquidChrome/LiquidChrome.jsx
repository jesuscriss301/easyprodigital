...
// Adaptado de React Bits (reactbits.dev/backgrounds/liquid-chrome) — MIT.
// Sin cambios de lógica; solo el guard de prefers-reduced-motion añadido
// (el original anima siempre). Motor: ogl — es el ÚNICO lienzo WebGL de la
// página, por eso el cursor de tinta va en canvas 2D, no en WebGL.
...
`
    ...
    let animationId
    if (reduce) {
      // una sola pasada estática, sin bucle
